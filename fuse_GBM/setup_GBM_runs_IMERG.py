...
obsversion = 'IMERG-ERA5' # NOTE IMERG input calculated by createForcing_IMERG.py
...
#calib_choices = [calibversion+'-longcalib1',calibversion+'-longcalib2',calibversion+'-longcalib3']
...
if host[:7]=='newblue':
	...
	fm_template = '/home/pu17449/src/fuse_templates/fm_GBM-p1deg_genforcing_template.txt'
