...
for choice in range(3):
	f_paramset = '/newhome/pu17449/data/fuse/fuse_GBM_v2-2/output/GBM-tiled2-2_'+str(dec)+'_calibrated'+str(choice+1)+'.nc'
...
for r in range(20):
	...
	f_out = '/newhome/pu17449/data/fuse/fuse_GBM_v2-2/output/GBM-tiled2-2_'+str(dec)+'_calibrateRand'+str(r+1).zfill(4)+'.nc'
