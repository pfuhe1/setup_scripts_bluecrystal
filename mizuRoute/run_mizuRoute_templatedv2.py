...
input_runs = {}
input_runs['rundef_900_'+paramname]='/newhome/pu17449/data/fuse/fuse_GBM_v2-2/output/GBM-tiled2-2_900_runs_def_qinst.nc'
input_runs['calib_900_'+paramname]  ='/newhome/pu17449/data/fuse/fuse_GBM_v2-2/output/GBM-tiled2-2_900_runs_pre_dist_qinst.nc'
input_runs['rundef_snowredist_900_'+paramname] = '/newhome/pu17449/data/fuse/fuse_GBM_v2-2_redistr/output/GBM-tiled2-2_900_runs_def_snoredist_qinst.nc'
input_runs['calib_snowredist_900_'+paramname]  = '/newhome/pu17449/data/fuse/fuse_GBM_v2-2_redistr/output/GBM-tiled2-2_900_runs_pre_dist_snoredist_qinst.nc'
...
control_template = '/newhome/pu17449/src/mizuRoute/route/settings/GBM-MERIT.control_template_v2'
...
for runname,inpath in input_runs.items():
		...
		if os.path.exists(control_file) and override:
		...
		sed_expr += 's#<PARAMNAME>#'+paramname+'#g; '
